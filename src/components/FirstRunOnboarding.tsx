...
export function FirstRunOnboarding() {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-[hsl(var(--brand)/0.7)] flex items-center justify-center p-4 animate-fade-in">
      <div className="relative w-full max-w-md bg-card rounded-lg border border-border overflow-hidden">
        {/* Close button */}
        <button
        ...
        {step === 'welcome' && (
          <div className="p-8 text-center space-y-6">
            ...
            <div className="space-y-2">
              <h2 className="text-2xl font-serif tracking-tight">Welcome to Sat Sorter</h2>
        ...
        {step === 'currency' && (
          <div className="p-8 space-y-6">
            <div className="text-center space-y-2">
              <h2 className="text-2xl font-serif tracking-tight">USD or Sats?</h2>
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className={cn(
                  'w-full p-4 rounded-md border text-left transition-all press-feedback',
                  currency === 'usd'
        ...
        {step === 'income' && (
          <div className="p-8 space-y-6">
            <div className="text-center space-y-2">
              <div className="h-12 w-12 rounded-md bg-success/15 flex items-center justify-center mx-auto">
                <DollarSign className="h-6 w-6 text-[hsl(var(--success))]" />
              </div>
              <h2 className="text-2xl font-serif tracking-tight">What's your monthly income?</h2>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="space-y-3">
              <div className="relative">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-lg font-mono text-muted-foreground">
                  {currency === 'usd' ? '$' : '⚡'}
                </span>
                <input
                  type="number"
                  ...
                  className="w-full h-14 pl-10 pr-4 rounded-md border border-border bg-background text-xl font-mono text-center focus:border-primary focus:outline-none transition-colors"
                  autoFocus
                  onKeyDown={(e) => {
