...
import { createSnapshot, formatSyncTime, getSyncStatusMessage } from '@/lib/budgetVersioning';
...
export function SaveToNostrFAB({ onSaveStart, onSaveComplete, onOpenSyncDialog }: SaveToNostrFABProps) {
  ...
  const { pushToCloud, checkSyncStatus, canSync, isSyncing, syncStatus } = useManualSync();
